...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><title>CSSTut - Vocabulary</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<div class="content">
  <p>CSS has 3 different parts to it's composition, and they're all important. To start, it uses items called <span class="style1">selectors</span> to determine what part of the document you want to define. Next, CSS uses <span class="style2">properties</span> to let you select which property (color, size, border, etc.) you want to edit, while the <span class="style3">values</span> actually let you change said property. The standard layout for your css file should be as follows:</p>
  <br /><br />

<div class="codebox" style="text-align:left"><span class="style1">selector {</span><br /> 
  <span class="style2">property</span><span class="style1">:</span> <span class="style3">value</span><span class="style1">;</span><br /> 
  <span class="style2">property</span><span class="style1">:</span> <span class="style3">value1</span> <span class="style3">value2</span> <span class="style3">value3</span><span class="style1">;</span><br /> <br />
  <span class="style1">}</span> <br />
  <span class="style1">body {</span><br /> 
  <span class="style2">font-size</span><span class="style1">:</span> <span class="style3">11px</span><span class="style1">;</span><br /> 
  <span class="style2">background-color</span><span class="style1">:</span> <span class="style3">white</span><span class="style3"></span><span class="style1">;</span><br /> 
  <span class="style1">}</span>
  </div>
<br /><br />

<p>A list of the standard properties and their uses can be found in the CSS Resources section.</p>
<br /><br />

<ul id="navigation">
<li class="left"><a href="intro.php">< Back</a></li>
<li class="right"><a href="layouts.php">Next ></a></li>
</ul>
