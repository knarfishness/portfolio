...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><title>CSSTut - Layouts</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<div class="content">
  <p>One of the main benefits of CSS is an advantage over tables when it comes to laying out a page. The &lt;DIV&gt; tag can be used to
   separate (DIVide) your page into segments, which can be placed adjacently, far apart, or even overlapping each other. Pre-made layouts 
   can be found on many different websites, usually separated into "Fluid-Width" (scales with browser window) and "Fixed-Width" (maintains the same size. 
   The following page offers many different CSS layouts for you to begin with:</p>
  <br /><br />

<div class="codebox">http://layouts.ironmyers.com/</div><br /><br />

<p>After selecting a layout for your site, open up your favorite text-editor and brainstorm an outline (i.e. Site Map) of the pages you 
would like to make. After sorting that out, you can move on to selecting a menu structure for your site...</p>
<br /><br />

<ul id="navigation">
<li class="left"><a href="vocabulary.php">< Back</a></li>
<li class="right"><a href="menus.php">Next ></a></li>
</ul>
