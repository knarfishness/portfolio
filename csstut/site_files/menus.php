...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><title>CSSTut - Menus</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<div class="content">
  <p>While a standard web menu can easily be made of PureCSS, other tools (i.e. JavaScript and others) can be used to give your menu extra features 
  that will make it stand out among other sites. The menu above is made with a tool called OpenCube, and while it is not completely free, it provides 
  an excellent platform for editing and creating a hybrid CSS/Javascript menu that has many features that take a very long time to set up individually.<br /> <br />
  In addition, other websites provide very comprehensive online utilities to generate the code for a menu automatically based on input. The following websites will help you to get your first menu set up quickly, and then by looking at the code, gain a better knowledge of how CSS is utilized to make menu items:
  </p>
  <br /><br />

<div class="codebox">http://www.opencube.com<br />http://www.cssmenumaker.com</div><br /><br />

<p>&nbsp;</p>
<br /><br />

<ul id="navigation">
<li class="left"><a href="layouts.php">< Back</a></li>
<li class="right"><a href="tricks.php">Next ></a></li>
</ul>
