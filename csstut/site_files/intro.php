...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><title>CSSTut - Introduction</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<div class="content">
  <p>Setting up Cascading Style Sheets for your website is actually very simple. It requires two pieces of code. To begin, make a new file with the extension ".css" (i.e. style.css) and paste the following at the top:</p>
  <br /><br />

<div class="codebox"><span class="style1">@charset "UTF-8";</span> <br />
  /* CSS Document */</div>
<br /><br />

<p>After this, you must attach your brand new CSS file to your HTML document, so that it can get style information from it. Somewhere in the HEAD section of your HTML, paste the following (correct the name if it you didn't name your file "style.css" After that is done, you are ready to consider layouts for your website:</p>
<br /><br />
<div class="codebox"> &lt;link rel="stylesheet" type="text/css" href="style.css" /&gt;</div><br />


<ul id="navigation">
<li class="left"><a href="../index.php">< Back</a></li>
<li class="right"><a href="vocabulary.php">Next ></a></li>
</ul>
