...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><title>About the CSSTut Site</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<div class="content">
  <p>This site, along with the resources it provides, can suffice as an excellent starting point for learning CSS. By right clicking
  this page, and clicking View Source, you can see all of the CSS and HTML that drives this page. Although the CSS/HTML of this page
  is written by hand, the Javascript Menu (follow the Buy Now! link for more info) is from OpenCube. The beautiful backgrounds are provided
  by Abduzeedo. More information on the both of them can be found below:</p>
  <br /><br />

<div class="codebox">http://www.opencube.com <br />
					http://www.abduzeedo.com</div><br /><br />

<p>The source of this webpage can also provide you with the techniques for centering a container on the page, handling opacity and transparency, switching CSS sheets with PHP/JavaScript, and provides a basic 1 column fixed-width setup to edit and tinker with.</p>
<br /><br />

<ul id="navigation">
<li class="left"><a href="tricks.php">< Back</a></li>
<li class="right"><a href="designer.php">Next ></a></li>
</ul>
...
<div align="center"><br />
    <a href="http://jigsaw.w3.org/css-validator/validator?uri=http%3A%2F%2Fwww.knarfishness.net%2Fcsstut&profile=css21&usermedium=all&warning=1&lang=en">
