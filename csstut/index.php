...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><title>Knarfishness.net CSSTut</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
...
<ul id="qm0" class="qmmc">
	...
	<li><a class="qmparent" href="javascript:void(0)">WHAT IS CSS?</a>
		...
		<ul>
		<li><a href="site_files/intro.php">Introduction</a></li>
		<li><span class="qmdivider qmdividerx" ></span></li>
		<li><a href="site_files/vocabulary.php">Vocabulary</a></li>
		</ul></li>
	...
	<li><a class="qmparent" href="javascript:void(0)">DEMONSTRATIONS</a>
		...
		<ul>
		<li><a href="site_files/layouts.php">Layouts</a></li>
		<li><a href="site_files/menus.php">Menus</a></li>
		<li><a href="site_files/tricks.php">Tricks / Advanced</a></li>
		</ul></li>
	...
	<li><a class="qmparent" href="javascript:void(0);">ABOUT THIS SITE</a>
		...
		<ul>
		<li><a href="site_files/site.php">About - The Site</a></li>
        	<li><span class="qmdivider qmdividerx" ></span></li>

		<li><a href="site_files/designer.php">About - The Designer</a></li>
		</ul></li>
...
<div class="content"><p>CSS, or Cascading Style Sheets, is an effective method of managing multiple style settings in the same document. As a web designer, it is
important to know how to use CSS to organize your code and make your site as effecient and optimized as possible. <br />
<br />

The following pages will hopefully help you learn how to use this powerful tool to the fullest. 
Special software is not needed to work with CSS or HTML files, any text editor will do, the only
requirement is a web browser. The recommended browser for viewing this webpage is <a href="http://www.getfirefox.com">Mozilla Firefox</a>.</p>
  <br /><br />

<div class="codebox">http://www.getfirefox.com</div><br /><br />

<p> Look for code boxes like the one above all throughout the site for copy-and-paste code that you can use to get started. If you're ready, hit next to begin...</p>
<br /><br />

<ul id="navigation">
<!-- <li class="left"><a href="#">< Back</a></li> -->
<li class="center">©2008 knarfishness.net web design</li>
<li class="right"><a href="site_files/intro.php">Next ></a></li>
</ul>
...
<tr>
<td><a href="site_files/stylechanger.php?style="><img src="images/thumb1.png" width="50" height="20" alt="Blue Space" /></a></td>
<td><a href="site_files/stylechanger.php?style=alt1"><img src="images/thumb4.png" width="50" height="20" alt="Abstract Bubbles" /></a></td>
<td><a href="site_files/stylechanger.php?style=alt2"><img src="images/thumb3.png" width="50" height="20" alt="Planet" /></a></td>
<td><a href="site_files/stylechanger.php?style=alt3"><img src="images/thumb2.png" width="50" height="20" alt="Spaceship" /></a></td>
</tr>
</table>
