...
//var myNav = new ImageNav($$('#kwick .kwick'),320,onClick function); works in FF
var ImageMenu = new Class({
	...
	initialize: function(myElements,options){
		...
		var fx = new Fx.Elements(myElements, {wait: false, duration: 200, transition: Fx.Transitions.quadOut});
